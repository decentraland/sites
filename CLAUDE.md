...
| `src/features/reels/`            | RTK Query endpoints + helpers for `/reels/*` (camera screenshots). Lightweight — uses `useSyncExternalStore`-style hooks; reels routes bypass `DappsShell` entirely.                                                                                                                                                    |
