...
| Discover (explore)         | `/discover` (Live Now + Featured + Explore), `/discover/communities`, `/discover/place/:position`, `/discover/world/:name`, `/discover/*` (404) | Heavy DappsShell route. Live scene preview (bevy embed + read-only LiveKit chat), places/worlds explore grid, communities list (detail links into `/social/communities/:id`).                   |
