...
// - src/components/events/EventDetailModal/EventDetailModalHero.spec.tsx — exact local-time
//   strings in the schedule subtitle.
// - src/components/events/EventDetailModal/EventDetailModalContent.spec.tsx — schedule range
//   formatting in the body.
// - src/components/events/AllExperiences/FutureCard.spec.tsx — passes start/finish ISOs to the
