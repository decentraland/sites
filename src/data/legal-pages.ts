...
export const CONTENT_POLICY: LegalPageDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: '4. Breaches of this Policy',
      paragraphs: [
    ...
    },
    {
      ...
      title: '5. Restricted Content',
      paragraphs: [
        'Any Content which qualifies as (i) intensely violent or graphic, (ii) gambling or (iii) sexually explicit, shall only be available to people aged 18 or older. If you upload, post, create, display, transmit or make available such Content on the Tools, you must provide sufficient warning as to this restriction. Failure to do so may result in termination of your Account pursuant to Section 15 of the Terms.'
      ]
    },
    {
      id: 'user-representations-and-warranties',
      title: '6. User Representations and Warranties',
      paragraphs: [
    ...
    },
    {
      ...
      title: '8. Limitations to Liability',
      paragraphs: [
