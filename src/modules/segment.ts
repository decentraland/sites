...
enum SectionViewedTrack {
  ...
  Download = 'Download',
  InviteFirstHero = 'Referrer Invite First Hero',
  InviteSecondHero = 'Referrer Invite Second Hero',
  InviteThirdHero = 'Referrer Invite Third Hero',
  InviteFaqs = 'Referrer Invite Faqs'
}
