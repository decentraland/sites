...
// The MANA diamond mark (Figma "Profile-Account" Wallets) shown next to balances and transaction
// amounts. Color and size come from the parent styled via currentColor / font-size.
const ManaMarkIcon = (props: SvgIconProps) => (
