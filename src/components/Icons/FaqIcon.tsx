...
type FaqIconProps = React.SVGAttributes<SVGElement> & {
  dark?: boolean
}

const FaqIcon = memo(function FaqIcon({ dark, ...props }: FaqIconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" fillRule="evenodd" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
