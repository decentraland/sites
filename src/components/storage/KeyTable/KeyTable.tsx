...
import { StoragePagination, TABLE_PAGE_SIZES } from '../StoragePagination'
...
const KeyTable: FC<KeyTableProps> = ({ keys, emptyLabel, onEdit, onDelete }) => {
  ...
  const { page, rowsPerPage, paginated, onPageChange, onRowsPerPageChange } = usePagination(keys, TABLE_PAGE_SIZES[0])
