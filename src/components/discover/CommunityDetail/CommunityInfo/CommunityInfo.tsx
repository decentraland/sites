...
function CommunityInfoComponent(props: CommunityInfoProps) {
  ...
  const renderActionButton = () => {
    ...
    if (!isLoggedIn) {
      return (
        <CTAButton isPrimary onClick={handleSignInToJoinClick}>
    ...
    return (
      <CTAButton isPrimary onClick={handleJoinClick} disabled={isPerformingCommunityAction}>
