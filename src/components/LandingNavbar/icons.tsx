...
const ManaEthIcon = memo(function ManaEthIcon(props: IconProps) {
  return (
...
/** The credits currency mark: a hexagonal "C". Drawn in currentColor so the chip's colour drives it —
 *  the same mark ui2 ships for the shop's credits, kept in sync by hand since this navbar is our own. */
const CreditsIcon = memo(function CreditsIcon(props: IconProps) {
  return (
    <svg width="16" height="16" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
...
const ManaMaticIcon = memo(function ManaMaticIcon(props: IconProps) {
  return (
