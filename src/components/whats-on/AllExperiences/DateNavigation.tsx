...
const DateNavigation = memo(
  ({ startOffset, columnCount, today, onNavigateLeft, onNavigateRight, allowPast = false }: DateNavigationProps) => {
    const { t } = useTranslation()
    const canGoBack = allowPast || startOffset > 0
