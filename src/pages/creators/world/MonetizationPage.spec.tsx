...
const { MonetizationPage } = require('./MonetizationPage') as typeof import('./MonetizationPage')
...
describe('MonetizationPage', () => {
  ...
  it('should render the coming-soon placeholder with the soon badge and a tile label', () => {
    ...
    expect(screen.getByText('page.creators.world.monetization.revenue')).toBeInTheDocument()
    expect(screen.getByText('page.creators.world.nav.monetization')).toBeInTheDocument()
  })
})
