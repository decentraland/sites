...
| PostToolUse(Edit\|Write\|MultiEdit) | `post-edit-i18n-parity.sh`       | When any `src/intl/*.json` changes, runs `scripts/check-i18n.mjs` (strict JSON, duplicate members, exact-set parity vs `src/intl/parity-baseline.json`) and surfaces its output (rule 9). Never blocks the edit.                                                                                                                                                                                                                                                                                                                     |
