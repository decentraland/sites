...
| `auth-flow`               | `src/hooks/useWalletAddress.ts`, `useAuthIdentity.ts`, `src/utils/signedFetch.ts`                                                                      | "auth", "identity", "wallet", "sign-in", "sign-out", "SSO", "signedFetch"                                                                                                                                        | —                                         | `docs/domains/{events,social,storage,blog}.md`                                                                          |
...
| `rtk-query-split`         | `src/services/*Client.ts`, `src/features/*/*.client.ts` (and `*.admin.client.ts`, `*.search.client.ts`)                                                | "RTK Query", "injectEndpoints", "transformResponse", "onQueryStarted", "base client", "endpoint injection", "reducerPath"                                                                                        | 17, 18                                    | `docs/domains/{events,blog,jump,social,cast,storage}.md`                                                                |
...
| `tracking-events`         | (reference/investigation)                                                                                                                              | "Segment", "analytics event", "tracking", "useTrackClick", "useDeferredTrack", "data-event", "download_started/success/failed", "click_id", "download_target", "utm", "campaign attribution", "where is X fired" | —                                         | `src/modules/segment.ts`, `segmentBeacon.ts`, `downloadTracking.ts`, `downloadClickCorrelation.ts`, `campaignParams.ts` |
...
| Doc                       | Covers                                                                                                              |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| `docs/domains/events.md`  | `src/features/events/`, `components/events/`, `pages/events/`. Events API + admin + lightweight discovery client.   |
...
| `docs/domains/places.md`  | `src/features/discover/`, `components/places/`, `pages/places/`. Destinations feed + live presence + scene preview. |
