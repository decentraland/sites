...
| Path                                         | Purpose                                                                                                                                                                                                       |
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `src/pages/events/`                          | Page components for the whats-on area (list, new/edit hangout, admin views).                                                                                                                                  |
| `src/components/events/`                     | Whats-on-specific UI components (cards, filters, hangout form, admin panels).                                                                                                                                 |
